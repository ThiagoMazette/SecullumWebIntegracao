...
namespace PontoWebIntegracaoExterna
{
    public partial class frmExemplo : Form
    {
        ...
        {
            txtBatidasDataInicio.Text = dateTimePicker1.Value.ToString("aaaa-MM-dd");
            txtBatidasDataFim.Text = dateTimePicker2.Value.ToString("aaaa-MM-dd");

            btnDepartamentosListar.PerformClick();
            btnFuncinariosListar.PerformClick();
            btnBatidasListar.PerformClick();
